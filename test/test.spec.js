...
describe("Superhero Api Suite", function() {
  describe("GET Request", function() {
    it("Should Get Superhero", async function() {
      let res = await apiHelper.sendGETRequest(
        baseUrl,
        apiEndPoint + idOfFirstSuperhero
      );
  ...
  describe("POST Request", function() {
    ...
    it("Should Create Superhero", async function() {
      ...
      let res = await apiHelper.sendPOSTRequest(
        baseUrl,
        apiEndPoint,
        requestBody
      );
    ...
    after(async function() {
      let res = await apiHelper.sendGETRequest(
        baseUrl,
        apiEndPoint + idOfCreatedSuperhero
      );
      console.log(res.body);
      res.status.should.equal(200);
      validator.dataTypeValidator(res);
  ...
  describe("PUT Request", function() {
    ...
    it("Should Update Superhero", async function() {
      ...
      let res = await apiHelper.sendPUTRequest(
        baseUrl,
        apiEndPoint + idOfCreatedSuperhero,
        requestBody
      );
  ...
  describe("DELETE Request", function() {
    ...
    it("Should Delete Superhero", async function() {
      let res = await apiHelper.sendDELETERequest(
        baseUrl,
        apiEndPoint + idOfCreatedSuperhero
      );
      console.log(res.body);
